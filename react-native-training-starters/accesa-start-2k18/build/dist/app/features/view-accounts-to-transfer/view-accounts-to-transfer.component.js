    ...
    function ViewAccountsToTransferComponent(props) {
        ...
        _this.renderAccountItem = function (account, key) {
            ...
            if (account.alias.startsWith(searchText) || searchText == "") {
                return (<ViewAccountsCard key={key} IBAN={account.iban} Budget={account.budget} Alias={account.alias} Currency={account.currency} ImagePath={require("../images/transfer_money_image.png")} OnPressRightButton={_this.onTransferButtonPress} RightButtonParameter={account.id} RightButtonImageHeight={'70%'} RightButtonImageWidth={"70%"} RightButtonColor={"#45E177"}/>);
            }
            return null;
        };
...
//# sourceMappingURL=view-accounts-to-transfer.component.js.map