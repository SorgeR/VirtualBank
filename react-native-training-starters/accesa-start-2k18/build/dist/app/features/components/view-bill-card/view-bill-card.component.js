...
var ViewBillsCard = /** @class */ (function (_super) {
    ...
    function ViewBillsCard(props) {
        ...
        _this.navigateToAddMembersToBill = function () {
            _this.props.navigation.navigate(AppRoutes.view_friends_to_add_to_bill, { "billID": _this.props.billId,
                "ownerID": _this.props.billOwnerId,
            });
        };
        _this.navigateToViewMembers = function () {
            _this.props.navigation.navigate(AppRoutes.view_members_of_bill, { "billID": _this.props.billId });
        };
        _this.renderButtons = function () {
            if (_this.state.loggedInUserID == _this.props.billOwnerId) {
...
//# sourceMappingURL=view-bill-card.component.js.map