...
var TransferMoneyComponent = /** @class */ (function (_super) {
    ...
    function TransferMoneyComponent(props) {
        ...
        _this.loadDestinationUserAccountsFromAPI = function () {
            ServiceUser.getAccounts(_this.state.userID)
                .then(function (response) {
                _this.setState({
        ...
        _this.renderAccountPickerData = function () {
            return (<View style={styles.pickerWrapperStyle}>
                <Picker mode={'dropdown'} style={styles.pickerStyle} selectedValue={_this.state.chosenAccountID} onValueChange={function (itemValue) {
    ...
    TransferMoneyComponent.prototype.render = function () {
        ...
        if (this.state.isLoading == false) {
            return (<View style={styles.wrapper}>
                ...
                _this.transferMoneyBetweenAccountsInAPI();
            }} disabled={!this.state.allValid} title={"SEND MONEY"} color={"#45E177"}/>
                                </View>
                            </View>
