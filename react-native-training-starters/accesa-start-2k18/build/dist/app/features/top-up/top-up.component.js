...
var TopUpComponent = /** @class */ (function (_super) {
    tslib_1.__extends(TopUpComponent, _super);
    ...
    TopUpComponent.prototype.getCurrentBudget = function () {
        var _this = this;
    ...
    TopUpComponent.prototype.freeTheTextInputs = function () {
        this.setState({
            sumToDeposit: 0,
        });
    };
    TopUpComponent.prototype.render = function () {
        return (<ImageBackground source={backgroundImage} style={styles.wrapper}>
            ...
            flexDirection: 'column'
                    ...
                    <View>
                        <View>
                            <Text style={styles.textBudgetStyle}> Your Current Budget </Text>
                        </View>
                    </View>
                    ...
                    <View>
                        <View>
                            <Text style={styles.textBudgetStyle}>{this.state.currentBudget} </Text>
                        </View>
                    </View>
                </View>
